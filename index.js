...
const weekDates = document.querySelector(".week-day h5");
...
const findCurrentDay = document.getElementsByTagName('div')[todayWeekDay];
findCurrentDay.style.fontWeight = "bold";
findCurrentDay.style.border = "2px solid red";
